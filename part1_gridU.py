...
for year in range (0,10):
    for month in range(1,13):
        ...
        subprocess.call(f"cdo setctomiss,0 uo/r1i1p1f1_uo_y19{year:02}_m{month:02}.nc uo/tmp_uo_y19{year:02}_m{month:02}.nc",shell=True) 
        subprocess.call(f"cdo remapnn,MJ_eORCA.nc uo/tmp_uo_y19{year:02}_m{month:02}.nc uo/remapnn_19{year:02}{month:02}_gridU.nc",shell=True)
        ...
        #subprocess.call(f"cdo setctomiss,0 vo/r1i1p1f1_vo_y19{year:02}{month:02}.nc vo/r1i1p1f1_vo_y19{year:02}_m{month:02}.nc",shell=True) 
        #subprocess.call(f"cdo selvar,vo vo/r1i1p1f1_vo_y19{year:02}_m{month:02}.nc vo/tmp_19{year:02}{month:02}_gridV.nc",shell=True)
        #subprocess.call(f"cdo remapnn,MJ_eORCA.nc vo/tmp_19{year:02}{month:02}_gridV.nc vo/remapnn_19{year:02}{month:02}_gridV.nc",shell=True)
